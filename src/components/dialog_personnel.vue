<template>
  <Overlay @close="$emit('close')">
      <div class="field">
        ...
        <input v-model="nom" id="nom" type="text" autocomplete="off">
      </div>
      <div class="field">
        <label for="prenom">Prenom:</label>
        <input v-model="prenom" id="prenom" type="text" autocomplete="off">
      </div>
      <div class="field">
        <label for="cni">CNI:</label>
        <input v-model="cni" id="cni" type="text" autocomplete="off">
      </div>
      <div class="field">
        <label for="numero">Numero de telephone:</label>
        <input v-model="telephone" type="text" autocomplete="off">
      </div>
      <div class="field">
      ...
      <div class="field">
        ...
        <input v-model="password" id="password" type="text" autocomplete="off">
      </div>
      <div class="field">
        <label for="adresse">Adresse:</label>
        <input v-model="adresse" id="adresse" type="text" autocomplete="off">
      </div>
      <div class="field">
      ...
      <div class="field">
        ...
        <input v-model="diplome" id="diplome" type="text" autocomplete="off">
      </div>
      <div class="field">
